...
class DbClient(withMetaclass(Singleton)):
    ...
    def get(self, https, cn, **kwargs):
        return self.client.get(https, cn, **kwargs)
    ...
    def pop(self, https, cn, **kwargs):
        return self.client.pop(https, cn, **kwargs)

    def getAll(self, https, cn):
        return self.client.getAll(https, cn)
